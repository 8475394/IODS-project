...
The first table discribes the total amount of going out between students and the summary table indicates that the mean of going out is around 3. 
...
```{r}
joined_alcohol %>% count(famrel, high_use) %>% mutate(freq = n / sum(n = 382) * 100)
```
