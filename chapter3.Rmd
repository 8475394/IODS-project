...
The first 3 tables illustrate the weekly studytime in general and between genders. To recall the measurement scale ranges between 1 and 4 where 
...
```{r}
joined_alcohol %>% count(studytime, high_use) %>% mutate(freq = n / sum(n = 382) * 100)
```
