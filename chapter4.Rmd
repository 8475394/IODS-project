...
From the table below LDA output indicates for example that 24.3 % of the training observations correspond to the low crime rate. It also provides the group means which are the average of each predictor within each class.
